            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="main_image" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == main_image ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == main_image ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == main_image ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == main_image ? 'active' : ''"
                    >
